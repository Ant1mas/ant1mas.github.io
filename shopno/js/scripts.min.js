...
var n=e.location.hash.substring(1),i=this._core.$stage.children(),r=this._hashes[n]&&i.index(this._hashes[n]);void 0!==r&&r!==this._core.current()&&this._core.to(this._core.relative(r),!1,!0)},this))};r.Defaults={URLhashListener:!1},r.prototype.destroy=function(){var n,i;t(e).off("hashchange.owl.navigation");for(n in this._handlers)this._core.$element.off(n,this._handlers[n]);for(i in Object.getOwnPropertyNames(this))"function"!=typeof this[i]&&(this[i]=null)},t.fn.owlCarousel.Constructor.Plugins.Hash=r}(window.Zepto||window.jQuery,window,document),function(t,e,n,i){function r(e,n){var r=!1,s=e.charAt(0).toUpperCase()+e.slice(1);return t.each((e+" "+a.join(s+" ")+s).split(" "),function(t,e){if(o[e]!==i)return r=!n||e,!1}),r}function s(t){return r(t,!0)}var o=t("<support>").get(0).style,a="Webkit Moz O ms".split(" "),l={transition:{end:{WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd",transition:"transitionend"}},animation:{end:{WebkitAnimation:"webkitAnimationEnd",MozAnimation:"animationend",OAnimation:"oAnimationEnd",animation:"animationend"}}},u={csstransforms:function(){return!!r("transform")},csstransforms3d:function(){return!!r("perspective")},csstransitions:function(){return!!r("transition")},cssanimations:function(){return!!r("animation")}};u.csstransitions()&&(t.support.transition=new String(s("transition")),t.support.transition.end=l.transition.end[t.support.transition]),u.cssanimations()&&(t.support.animation=new String(s("animation")),t.support.animation.end=l.animation.end[t.support.animation]),u.csstransforms()&&(t.support.transform=new String(s("transform")),t.support.transform3d=u.csstransforms3d())}(window.Zepto||window.jQuery,window,document),$(function(){function t(t,e){e=void 0!==e?e:0;var n=window.pageYOffset,i=window.innerHeight,r=t.offset().top;return n+i>=r+e&&n+i-r-e<=i}$(".nav-menu-animated").on("click",function(){$(this).toggleClass("opened")}),$(window).on("scroll",function(){var t=$("body .side-menu-btn-wrapper");window.pageYOffset>=150?t.addClass("active"):t.removeClass("active")}),$("body nav .nav-menu-animated").on("click",function(){$("body .side-menu").addClass("opened"),$("body .side-menu-site-wrapper").addClass("opened")}),$("body .side-menu-site-wrapper").on("click",function(){$("body .side-menu").removeClass("opened"),$("body .side-menu-site-wrapper").removeClass("opened"),$(".nav-menu-animated").removeClass("opened")}),$("body section.services .item-wrapper .preview .link").on("click",function(){$(this).parents(".item-wrapper").find(".content").addClass("active")}),$("body section.services .item-wrapper .content i").on("click",function(){$(this).parents(".content").removeClass("active")}),$("body").find(".animation").each(function(){!0===t($(this))&&$(this).addClass("animated")}),$(document).on("scroll",function(){$("body").find(".animation").each(function(){var e=void 0!==$(this).attr("data-anim-offset")?parseInt($(this).attr("data-anim-offset")):0;!0===t($(this),e)&&$(this).addClass("animated")})}),$(document).ready(function(){$(".owl-carousel.dots-only").owlCarousel({items:1,loop:!0}),$(".owl-carousel.nav-only").owlCarousel({items:1,loop:!0,nav:!0,dots:!1,mouseDrag:!1,touchDrag:!1,pullDrag:!1,navText:["<i class='ic-move-left'></i>","<i class='ic-move-right'></i>"]});var t=$("section.they_says .owl-carousel.dots-only"),e=$("section.they_says .owl-carousel.nav-only");t.owlCarousel(),e.owlCarousel(),t.on("changed.owl.carousel",function(t){e.trigger("to.owl.carousel",t.page.index)}),e.on("changed.owl.carousel",function(e){t.trigger("to.owl.carousel",e.item.index-2)})})});